  ...
  Future<void> _submit() async {
    ...
    if (match == null || int.parse(match.group(1)!) != _wardId) {
      setState(() {
        _saving = false;
        _status = null;
        _error = 'Resident ID not found in Ward $_wardId records. '
            ...
            return SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Almost there! Tell us who you are and where you live.',
                    ...
                    TextFormField(
                      ...
                      validator: (v) =>
                          (v?.trim().length ?? 0) >= 3 ? null : 'Enter your full name',
                    ),
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      items: [
                        for (final w in wards)
                          DropdownMenuItem(
                            value: w.id,
                            child: Text('${w.name}  ·  ${inrCompact(w.budgetPool)}',
                    ...
                    TextFormField(
                      ...
                      validator: (v) =>
                          (v?.trim().isNotEmpty ?? false) ? null : 'Enter your Resident ID',
                    ),
                    const SizedBox(height: 24),
