...
/// (needsContact is kept for compatibility; sign-in needs only ONE verified contact now,
/// the other is optional and verified later from Profile.)
...
class AuthProvider extends ChangeNotifier {
  ...
  /// Residents sign in with ONE verified contact; the other is optional and can be
  /// verified later from Profile. (Phone-only accounts start with a placeholder email.)
